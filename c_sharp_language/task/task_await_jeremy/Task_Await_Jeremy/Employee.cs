...
namespace Task_Await_Jeremy
{
    public class Employee
    {
        ...
        public async static Task<List<Employee>> GetEmployeeAsync()
        {
            await Task.Delay(3000);

            //throw new NotImplementedException("GetEmployeeAsync is not implemented");

            return GetEmployees();
        }

        public static Task<List<Employee>> GetEmployeeAsync2()
        {
            Task<List<Employee>> empTask = Task.Factory.StartNew(() =>
            {
        ...
        public static Task<List<Employee>> GetEmployeeAsync3()
        {
            Task<List<Employee>> empTask = Task.Factory.StartNew(() =>
            {
                for (int i = 0; i < 10000; i++)
